...
```text
hoek elements=8 nodes=9 over=5 plastic=5 fail=tension max_sig1=4.423603797 back_sig1=1.391894428 min_sig3=-3.779564515 ucs=18.80243413 cutoff=0.6126583006 pressure=0.67797 reaction=32.76855 applied=-32.76855 residual=15.11887723 residual_after=5.911552654 iterations=5 e=30000 nu=0.25
```
...
- Treat the iteration count as a converged plastic analysis. Plastic strain is stored, and the step is line-searched, but the stiffness stays elastic. On this roof the imbalance stops at 5.911552654. A consistent tangent is not in this file. It is not a global rebalance and it is not UDEC.
